...
function openProjectModal(id) {
  ...
  if (!data.embed && (!data.images || !data.images.length)) {
    mediaHTML = `
...
const projectData = {
  ...
  helen: {
    ...
    embed: 'https://georgewtgadd.github.io/st-barnabas/01-PEOLC/03-understanding-helen/',
  ...
  arthur: {
    ...
    images: [],
    embed: 'https://georgewtgadd.github.io/st-barnabas/01-PEOLC/05-comm-acp/',
