...
const projectData = {
  vp: {
    ...
    body: `<p>Students on a wide range of courses, particularly in healthcare, are required to complete placement learning. Placement experiences in the East Midlands are becoming increasingly difficult to source and more expensive to resource. To address this, a bespoke "Virtual Placement" (VP) platform was designed to provide authentic, practice-oriented experiences. Students are introduced to their practice supervisor, Krish, who guides them along their learning journey, including virtual home visits to a patient, Lionel.</p>
